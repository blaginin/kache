...
To watch the hits arrive, open `kache monitor` in another terminal first.

![kache monitor following two builds live, then the Why and Store tabs](https://raw.githubusercontent.com/kunobi-ninja/kache/main/assets/monitor.gif)
