...
[Other install methods](/docs/getting-started/installation) include Homebrew, APT, winget, and Nix. The [quick start](/docs/getting-started/quick-start) shows how to confirm cache hits. Run `kache monitor` to [watch builds live](/docs/monitor). Comparing compiler caches? Read [Kache or sccache?](/docs/getting-started/comparison).
